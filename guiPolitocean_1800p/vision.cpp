     ...
     // Mat canny_output;
      ...
      for( size_t i = 0; i< contours.size(); i++ )
        ...
        //acquisisco 20 campioni e ne faccio la moda
            ...
            circle_moda[final] = Vision::mean_mode(circ);
            triangle_moda[final] = Vision::mean_mode(tri);
            line_moda[final] = Vision::mean_mode(line);
            square_moda[final]= Vision::mean_mode(rect);
            ...
            int circle_final = Vision::mean_mode(circle_moda);
            int triangle_final = Vision::mean_mode(triangle_moda);
            int line_final = Vision::mean_mode(line_moda);
            int square_final = Vision::mean_mode(square_moda);
